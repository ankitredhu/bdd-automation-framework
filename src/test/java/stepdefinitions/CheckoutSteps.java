...
public class CheckoutSteps extends BaseTest {
	...
	// Scenario: Registering while checking out
	@Given("I choose to register during checkout")
	public void i_choose_to_register_during_checkout() {
		checkoutPage.signupOnCheckout();
	}
}
